...
describe('addEnumSuffixToModuleTitles function', () => {
  it('should return the same array if there is no duplicate', () => {
    const fakeModules = [{ moduleType: { title: 'lorem' } }, { moduleType: { title: 'ipsum' } }, { moduleType: { title: 'foo' } }];
  ...
  it('should return an array of modules with count added on the title of duplicates', () => {
    const fakeModules = [{ moduleType: { title: 'lorem' } }, { moduleType: { title: 'lorem' } }, { moduleType: { title: 'ipsum' } }, { moduleType: { title: 'foo' } }];
    const actual = addEnumSuffixToModuleTitles(fakeModules);
    const expected = [{ moduleType: { title: 'lorem 1' } }, { moduleType: { title: 'lorem 2' } }, { moduleType: { title: 'ipsum' } }, { moduleType: { title: 'foo' } }];
