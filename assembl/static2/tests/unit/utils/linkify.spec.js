...
describe('transformLinksInHtml function', () => {
  it('should transform links in an html string', () => {
    ...
    const expected = '<p>Foobar <a href="http://www.example.com/" class="linkified" target="_blank">http://www.example.com/</a> and text after</p>';
  ...
  it('should turn www.youtube.com links into embedded videos', () => {
    ...
    const actual = transformLinksInHtml(input);
    const expected = '<p>Foobar: <a href="https://www.youtube.com/watch?v=lnhB-y_WJSk" class="linkified" target="_blank">https://www.youtube.com/watch?v=lnhB-y_WJSk</a></p>';
    expect(actual).toEqual(expected);
  });
