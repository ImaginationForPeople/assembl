          ...
          render={({ handleSubmit, submitting, initialValues, values, form }) => {
            ...
            return (
              <div className="admin-content">
                <AdminForm handleSubmit={handleSubmit} pristine={pristine || startDateConflict || endDateConflict} submitting={submitting}>
                  <div className="form-container">
                    ...
                    />
                    <Field editLocale={editLocale} name="headerTitle" component={MultilingualTextFieldAdapter} label={I18n.t('administration.landingPage.header.titleLabel')} required />
                    <Field
                      ...
                      required
                    />
                    <Field editLocale={editLocale} name="headerButtonLabel" component={MultilingualTextFieldAdapter} label={I18n.t('administration.landingPage.header.buttonLabel')} required={false} />
                    <Field name="headerImage" component={FileUploaderFieldAdapter} label={I18n.t('administration.landingPage.header.headerImage')} />
                    <p className="label-indication">{I18n.t('administration.landingPage.header.headerDescription')}</p>
                    <div className="flex">
                      <Field name="headerLogoImage" component={FileUploaderFieldAdapter} label={I18n.t('administration.landingPage.header.logoHelper')} />
                    </div>
