...
export const createMutationsPromises = (client: ApolloClient) => (values: DiscussionPreferencesFormValues, initialValues: DiscussionPreferencesFormValues) => [
  () =>
      ...
      client
        ...
        .then(() => {
          if (values.slug !== initialValues.slug) {
            ...
            window.location.assign(get('administration', { slug: values.slug, id: 'discussion' }, { section: SECTION_DISCUSSION_PREFERENCES }));
          }
        }))
];
