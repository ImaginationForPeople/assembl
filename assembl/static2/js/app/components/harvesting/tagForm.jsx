...
const valueContainer = (pristine: boolean, onValidate?: (?SyntheticEvent<HTMLFormElement>) => ?Promise<?Object>, onCancel?: (SyntheticEvent<HTMLDivElement>) => void) => ({ children, ...props }) => {
