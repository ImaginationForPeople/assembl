...
const SynthesisPreview = ({ synthesis, refetchQueries }: Props) => {
  ...
  const previewStyle = synthesis.img && synthesis.img.externalUrl ? { backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${synthesis.img.externalUrl})` } : null;
  return (
